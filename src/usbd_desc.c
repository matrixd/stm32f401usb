...
#define USBD_MANUFACTURER_STRING      "Anon"

#define USBD_PRODUCT_HS_STRING        "SomeDEV"
#define USBD_SERIALNUMBER_HS_STRING   "00000000111B"

#define USBD_PRODUCT_FS_STRING        "SomeDEV"
#define USBD_SERIALNUMBER_FS_STRING   "00000000111C"
...
__ALIGN_BEGIN uint8_t USBD_DeviceDesc[USB_SIZ_DEVICE_DESC] __ALIGN_END =
  {
    ...
    USB_OTG_HS_MAX_PACKET_SIZE,      /*bMaxPacketSize*/
